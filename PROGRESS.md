...
[--:--] DONE: CRITICAL — Fixed Qwen3 thinking leak. /no_think is a soft switch that still emits <think> tokens. Replaced with hard switch: pre-filled empty think block in assistant turn (<think>\n\n</think>\n\n). This is what Qwen3's tokenizer does with enable_thinking=False. Force-close kept as safety net with WARNING log.
